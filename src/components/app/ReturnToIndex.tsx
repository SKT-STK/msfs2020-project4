...
const ReturnToIndex = () => {
  return (
    <div className='relative w-full h-[75px] border-b-4'>
      <Link to='/' className='fixed left-0 top-0 border-[35px]
        border-white rounded-[200px] cursor-pointer hover:border-[#FF5]
        ml-8 mt-[34px] scale-[.075] -translate-x-1/2 -translate-y-1/2'
      >
